...
#ifdef GAMECUBE
	printf("[Sound] InitDirectSound starting...\n");
#endif

	audio_backend_initialised = AudioBackend_Init();

#ifdef GAMECUBE
	printf("[Sound] AudioBackend_Init returned %d\n", audio_backend_initialised);
#endif
...
#ifdef GAMECUBE
	printf("[Sound] Calling StartOrganya...\n");
#endif
	StartOrganya("Org/Wave.dat");
#ifdef GAMECUBE
	printf("[Sound] StartOrganya done\n");
#endif
